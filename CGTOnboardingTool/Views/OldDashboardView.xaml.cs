...
namespace CGTOnboardingTool.Views
{
    ...
    /// </summary>
    public partial class OldDashboardView : Page
    {
        ...
        public OldDashboardView(ref Report report)
        {
            InitializeComponent();
            this.report = report;
            display(report.Rows());
        ...
        public OldDashboardView(ref Report report, ref String client, ref String tax)
        {
            InitializeComponent();
